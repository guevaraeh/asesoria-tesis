      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand-lg mb-4 topbar bg-dark" data-bs-theme="dark">
            <div class="container-fluid">
                {{--<span class="navbar-brand mb-0 h1"><img src="{{ asset('libraries/wp-content/uploads/2021/02/favicon.png') }}" class="img-fluid" alt="Responsive image" width="20" height="20"> Administrador</span>--}}
